...
|	  : 2.02a Custom Build to check capID;
|         : Keith - change var enableVariableBranching = true; to False
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var ParcelValidatedNumber = null;
var cancel = false;
...
//Reset error message and debug to ensure script does not termiante due to **Error
message = "";
debug = "";
