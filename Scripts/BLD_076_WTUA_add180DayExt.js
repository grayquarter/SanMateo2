/*******************************************************
| Script/Function: add180DayExt() - (ID76)
| Created by: Nicolaj Bunting
| Created on: 10Nov20
| Usage: When task "Inspections" has status set to "180 Day Extension" set ASI "Date of Extension" to today's date, set ASI 
| "Expiration Date" to 180 days from today, set ASI "180 day Extension" to checked, send notification "BLD_PERMITEXTENDED" to 
| "Applicant" contacts, record owner, all licensed professionals
| Modified by: ()
*********************************************************/
(function () {
    ...
    addParameter(params, "$$numDays$$", '180');
    ...
    editAppSpecific("180 day Extension", "CHECKED", capId);
