/*******************************************************
| Script/Function: add60DayExt() - (ID374)
| Created by: Nicolaj Bunting
| Created on: 13Sep21
| Usage: When task "Inspections" has status set to "60 Day Extension" set ASI "Date of Extension" to today's date, set ASI
| "Expiration Date" to 60 days from today, set ASI "60 day Extension" to checked, send notification "BLD_PERMITEXTENDED" to "Applicant" 
...
(function () {
    ...
    addParameter(params, "$$numDays$$", '60');
    ...
    editAppSpecific("60 day Extension", "CHECKED", capId);
