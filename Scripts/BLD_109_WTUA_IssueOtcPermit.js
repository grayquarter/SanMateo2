/*******************************************************
| Script/Function: issueOtcPermit() - (ID109)
| Created by: Nicolaj Bunting
| Created on: 2Dec20
| Usage: When task "Planning Review" has status set to "Passed" Or "Passed with Conditions" close task "Review Consolidation" with 
| status of "Approved", close task "Ready to Issue Permit" with status of "Permit Issued", call ID54
| Modified by: ()
*********************************************************/
(function () {
