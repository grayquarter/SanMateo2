...
var controlString = "ACACheckVolumeBefore";		// Standard choice for control
...
function loadASITables4ACA_x() {
    ...
    while (tai.hasNext()) {
        ...
        while (tsmfldi.hasNext())  // cycle through fields
        {
            ...
            var tcol = tsmcoli.next();
            // var tval = tsmfldi.next().getInputValue();  // Modified 4/28/2015 Ray Schug - Getting error when getInputValue() was used on String.
            var tfv = tsmfldi.next();
            var tval = null;
            if (!tfv) {
                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = [NULL]" + tfv + typeof (tfv));
            } else if (tfv.getInputValue) {                // Check to see if you can call getInputValue if not check to see if you have a string else return null.
                tval = tfv.getInputValue();
                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = " + tval);
            } else if (typeof (tfv) == "string" || tfv.getClass() == "class java.lang.String") {
                tval = tfv;
                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = " + tval);
//            } else if (tfv && tfv.toString) {
//                tval = tfv.toString();
//                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = " + tval);
            } else if (tfv) {
                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = [NULL]" + tfv + typeof (tfv) + " " + tfv.getClass());
            } else {
                logDebug("ASI Table Array : " + tn + " [" + numrows + "]: " + tcol.getColumnName() + " = [NULL]" + tfv + typeof (tfv));
            }
            tempObject[tcol.getColumnName()] = tval;
