/*******************************************************
| Record Type: Building/Commercial/New/NA
| Pageflow: BLD_NEW_STRUCC
...
var useCustomScriptFile = true;  // if true, use Events->Custom Script,
// else use Events->Scripts->INCLUDES_CUSTOM
var SA = null;
...
/-----------------------------------------------------------------------------------------------------*/
try {
    //Script 462 Documents Check
    include("BLD_462_Before_DocsCheck");
}
catch (ex) {
...
if (debug.indexOf("**ERROR") > 0) {
    ...
    if (cancel) {
        ...
        // message += "<img src='/citizenaccess/Admin/images/empty.gif' onload=\"$('.ACA_Message_Error')
        // .addClass('ACA_Message_Notice')
