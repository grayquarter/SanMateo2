/*******************************************************
| Record Type: Building/Signs and Awnings/NA/NA
| Pageflow: BLD_ACC_STRUC
...
/-----------------------------------------------------------------------------------------------------*/
try {
    // Residential Signs and Awings
    if (matches("Building/Signs and Awnings/NA/NA", appTypeString) == true) {
        //Script 491 Signs & Awnings Documents Check
        include("BLD_491_Before_SignsAwningsDocsCheck");
    }

    //aa.sendMail("noreply@smcgov.org", "PI_Test@avocette.com", "",
    //    "SMC Test: BLD_ACC_STRUC_Before_AttachDocs", debug);    //debug
}
catch (ex) {
