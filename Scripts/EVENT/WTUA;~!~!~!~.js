...
if (appMatch('Building/*/*/*') && !appMatch('Building/Residential/*/*')) {
	include('ES_BLD_WTUA'); /* replaced branch(ES_BLD_WorkflowTaskUpdateAfter) */
	}

if (appMatch('Planning/*/*/*')) {
	include('ES_PLN_WTUA'); /* replaced branch(ES_PLN_WorkflowTaskUpdateAfter) */
	}

if (appMatch('PublicWorks/*/*/*')) {
	include('ES_PW_WTUA'); /* replaced branch(ES_PW_WorkflowTaskUpdateAfter) */
	}
...
if (appMatch('WasteMgmt/*/*/*')) {
	include('ES_WM_WTUA'); /* replaced branch(ES_WM_WorkflowTaskUpdateAfter) */
	}
