/*******************************************************
| Script Title: tempPowerPoleReqDoc(ID226)
| Created by: Jei Yang
| Created on: 22Feb21
| Event: Before
| Usage: If no doc of type "Site Plan | SITE" Then block submittal, display message
...
try {
    (function () {
        Avo_LogDebug("ID226 tempPowerPoleReqDoc()", 1);
