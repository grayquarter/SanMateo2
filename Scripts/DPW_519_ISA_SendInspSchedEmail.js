...
| Created on: 
| Usage: When inspection is scheduled If inspection name does not have "Final" in name Then send notification "DPW_INSPECTIONSCHEDULED" 
...
(function () {
    ...
    var template = "DPW_INSPECTIONSCHEDULED";
    ...
    //addParameter(params, "$$inspSchedTime$$", String(inspSchedTime));
...
aa.sendMail("noreply@smcgov.org", "PI_Test@avocette.com", "", "SMC Prod: DPW_519_ISA_SendInspSchedEmail", debug); //debug
