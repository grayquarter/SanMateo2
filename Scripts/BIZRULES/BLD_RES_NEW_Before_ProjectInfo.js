...
try {
    ...
    if (matches("Building/Residential/Re-Roof/NA", appTypeString) == true) {
        //Script 201 Reroof Check Fire Risk
        include("BLD_201_Before_ReroofCheckFireRisk");
    }
}
catch (ex) {
...
//aa.sendMail("noreply@smcgov.org", "PI_Test@avocette.com", "", "SMC Supp: BLD_RES_NEW_Before_ProjectInfo", debug); //debug
