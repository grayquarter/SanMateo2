...
if (appMatch('WasteMgmt/*/*/*')) {
    ...
    for (yy in contacts)
        if (contacts[yy].getCapContactModel().getPeople().getContactType() == 'Waste Plan Contact')
...
if (appMatch('WasteMgmt/Management Final/NA/NA') && matches(wfStatus, 'Approved', 'Citizen Reviewed and Approved') && emailAddress) {
    sendEmailwAttchmnt('noreply@smcgov.com', emailAddress, '', 'Waste Management Plan Approved', 'Thank you for using our RecycleWorks Waste Management Plan online site.<br><br>Your projects Section 2 Waste Management Plan (' + capIDString + ') has been approved. Please find attached the electronic copy of your project+ÛGÈºG‰Ûs Section 2 report. Your project can now be finalized by the County+ÛGÈºG‰Ûs Building Department. Please contact the Building Department for more information and next steps.<br><br>If you have any questions about the Waste Management Plan, please contact the C&D Program Coordinator at sustainability@smcgov.org or call at (650) 599-1498.', 'WM Plan', 'RecordID', capIDString, '', '');
}
...
if (appMatch('WasteMgmt/Management Plan/NA/NA') && matches(wfStatus, 'Approved') && emailAddress) {
    sendEmailwAttchmnt('noreply@smcgov.com', emailAddress, '', 'Waste Management Plan Approved', "Thank you for using our RecycleWorks Waste Management Plan online site.<br><br>Your projects Section 1 Waste Management Plan ('+capIDString+') has been approved. Please find attached the electronic copy of your project+ÛGÈºG‰Ûs Section 1 report.<br><br>Along with a completed Section 2 of the Waste Management Plan, please be sure to save your receipts, photos, letters or other documentation of construction & demolition (C&D) materials diverted or disposed, as proof that your project has met the County's waste management requirement prior to your final inspection.<br><br>'+t2+'<br><br>If you have any questions please contact the C&D Program Coordinator at sustainability@smcgov.orgor call at (650) 599-1498.", 'WM Plan', 'RecordID', capIDString, '', '');
