/*******************************************************
| Script/Function: add30DayExt() - (ID375)
| Created by: Nicolaj Bunting
| Created on: 13Sep21
| Usage: When task "Inspections" has status set to "30 Day Extension" set ASI "Date of Extension" to today's date, set ASI
| "Expiration Date" to 30 days from today, set ASI "30 day Extension" to checked, send notification "BLD_PERMITEXTENDED" to "Applicant" 
...
(function () {
    ...
    addParameter(params, "$$numDays$$", '30');
    ...
    editAppSpecific("30 day Extension", "CHECKED", capId);
