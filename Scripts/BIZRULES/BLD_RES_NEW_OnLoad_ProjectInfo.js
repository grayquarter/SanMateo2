...
/-----------------------------------------------------------------------------------------------------*/
try {
    //Script 165 Set Zoning
    include("BLD_165_OnLoad_SetZoning");

    //Script 355 Residential Revision Copy ASI
    include("BLD_355_OnLoad_ResRevCopyAsi");

    if (matches("Building/Residential/Addition/NA", appTypeString) == true) {
        //Script 312 Populate Fire Severity Zone
        include("BLD_312_OnLoad_FireSeverityZonePopulate");
    }
}
catch (ex) {
