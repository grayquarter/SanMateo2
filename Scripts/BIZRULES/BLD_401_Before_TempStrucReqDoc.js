...
| Created on: 19Apr22
| Event: Before
| Usage: If no doc of type "Plan Set | PLANS" Or if ASI
| "Will traffic / pedestrian control be required for this event?" is "Yes" and no document of type
| "Traffic / Pedestrian Control Plan | TRAFPED" Then block submittal, display message
...
try {
    (function () {
        ...
        var trafficPedControl = String(AInfo[
            "Will traffic / pedestrian control be required for this event?"]);
        Avo_LogDebug("Will traffic / pedestrian control Req?(" + trafficPedControl + ")", 2); //debug
