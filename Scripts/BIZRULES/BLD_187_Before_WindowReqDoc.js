/*******************************************************
| Script Title: windowReqDoc(ID187)
| Created by: Jei Yang
| Created on: 8Jan21
| Event: Before
| Usage: If parcel attributes "ZONING DESIGNATION", "ZONING 2", "ZONING 3", "ZONING 4" include values
| "CD" or "DR" and document type "Colors/Finish and Materials | COLOR" is not uploaded Then block
| submittal, display message
...
try {
    (function () {
        Avo_LogDebug("ID187 windowReqDoc()", 1);
