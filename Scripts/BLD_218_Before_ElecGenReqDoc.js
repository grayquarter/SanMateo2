/*******************************************************
| Script Title: electGenReqDoc(ID218)
| Created by: Jei Yang
| Created on: 17Feb21
| Event: Before
| Usage: If document type "Plan Set | PLANS" is not uploaded Then block submittal, display message
...
try {
    (function () {
        Avo_LogDebug("ID218 electGenReqDoc()", 1);
