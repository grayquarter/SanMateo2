...
| Action# : N/A
|
| Notes   : Check to makes sure X documents are attached
|
/------------------------------------------------------------------------------------------------------*/
/*------------------------------------------------------------------------------------------------------/
...
var controlString = "ACABeforeCheckDocCount";		// Standard choice for control
...
//true ^ docList = new Array();
//true ^ docList = getDocumentList();
//docList.length == 0 ^ showMessage = true; comment(" No documents are attached");cancel = true; comment("Doc Count = "+docList.length)
